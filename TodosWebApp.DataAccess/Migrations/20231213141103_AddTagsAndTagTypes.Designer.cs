...
namespace TodosWebApp.DataAccess.Migrations
{
    ...
    [Migration("20231213141103_AddTagsAndTagTypes")]
    partial class AddTagsAndTagTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodosWebApp.Model.Entities.Tag", b =>
                {
                    ...
                    b.Property<int>("TagTypesId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("TagTypesId");
            ...
            modelBuilder.Entity("TodosWebApp.Model.Entities.Tag", b =>
                {
                    b.HasOne("TodosWebApp.Model.Entities.TagTypes", "Types")
                        .WithMany()
                        .HasForeignKey("TagTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
